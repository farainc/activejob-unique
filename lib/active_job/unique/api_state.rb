    ...
    module ApiState
      ...
      module ClassMethods
        ...
        def getset_progress_stage_state_flag(job, progress_stage)
          ...
          timestamp = job.queue_adapter_uniqueness_api.getset_progress_stage_state_flag(state_key, state_value).to_f
          job.queue_adapter_uniqueness_api.expire_progress_stage_state_flag(state_key, PROGRESS_STATE_EXPIRATION + 10)
        ...
        def expire_progress_stage_state_flag(job, progress_stage)
          ...
          job.queue_adapter_uniqueness_api.expire_progress_stage_state_flag(state_key, 0)
        end
      end
    end
  end
